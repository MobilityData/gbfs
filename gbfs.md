...
`datasets[].country_code` | OPTIONAL | String | The country code of the operating area. The field MUST NOT be specified if the operating area spans multiple countries.
