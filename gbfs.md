...
&emsp;&emsp;\-&nbsp;`start` <br/>*(added in v2.1-RC2)* | Yes | Non-Negative Integer | Number of kilometers *(inclusive)* that have to elapse before this segment starts applying.
...
&emsp;&emsp;\-&nbsp;`start` <br/>*(added in v2.1-RC2)* | Yes | Non-Negative Integer | Number of minutes *(inclusive)* that have to elapse before this segment starts applying.
