...
&emsp;&emsp;\-&nbsp;`vehicle_type_ids` <br/>*(as of v3.0)* | Conditionally REQUIRED | Array | REQUIRED if `vehicle_types_capacity` is defined. The `vehicle_type_ids`, as defined in `vehicle_types.json`, that may park at the virtual station.
