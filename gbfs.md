...
* Timestamp - Timestamp fields MUST be represented as strings in [RFC3339 format](https://www.rfc-editor.org/rfc/rfc3339), for example `2023-07-17T13:34:13Z`. The offset (timezone) MUST be UTC, so the timestamp MUST end in `Z`. 
...
```json
{
  "last_updated": "2023-07-17T13:34:13Z",
  "ttl": 3600,
  "version": "3.0-RC",
  "data": {
    ...
    "stations": [
      {
        ...
        "is_renting": true,
        "is_returning": true,
        "last_reported": "2023-07-17T13:34:13Z",
    ...
    "alerts": [
      {
        ...
        "times": [
          {
            "start": "2023-07-17T13:34:13Z",
            "end": "2023-07-18T13:34:13Z"
          }
        ],
        "url": [
          {
