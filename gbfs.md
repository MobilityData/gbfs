...
| \- `description`<br/>*(added in v3.0-Draft)*| OPTIONAL| String| Customer-readable description of the vehicle type outlining special features or how-tos.
