...
\-&nbsp;`is_charging_station` | OPTIONAL | Boolean | Does the station support vehicle charging? <br /><br /> `true` - Vehicle charging is available at this station. <br /> `false` -  Vehicle charging is not available at this station.
