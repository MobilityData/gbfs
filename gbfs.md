...
\- `car_type` | Optional | Enum | The type of car. <br /><br />Current valid issues are: <br /><ul><li>`ultra mini` (e.g smart fortwo)</li><li>`compact`</li><li>`sedan`</li><li>`station-wagon`</li><li>`suv`</li><li>`minivan`</li><li>`pickup truck`</li><li>`cargo van`</li></li>`other`
